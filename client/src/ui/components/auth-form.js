 ...
 * Auth UI: Login & Register pages 100% IDENTICAL to Google Stitch Export.
 * Source: stitch_plantneeds_botanical_login/login_page_plantneeds & register_page_plantneeds
 */
    ...
    container.innerHTML = `
      <div class="h-screen w-full font-body-md text-on-surface antialiased flex items-center justify-center relative overflow-hidden font-['Plus_Jakarta_Sans']">
        ...
        <div class="absolute inset-0 z-0">
          <div class="w-full h-full bg-cover bg-center" style="background-image: url('/assets/auth-bg.jpg');"></div>
          ...
          <div class="glass-panel rounded-[32px] p-8 sm:p-10 flex flex-col items-center shadow-lg" style="background: rgba(255, 255, 255, 0.5); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); border: 1px solid rgba(255, 255, 255, 0.4);">
            ...
            <div class="mb-6 text-center">
              <div class="flex items-center justify-center gap-2 mb-2">
                <span class="material-symbols-outlined text-primary text-[32px]" style="color: #154212; font-variation-settings: 'FILL' 1;">potted_plant</span>
