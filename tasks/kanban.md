...
| T-08 | Plants CRUD + care-log API endpoints | 4 | 2026-09-01 (`pending-commit`) | [[docs/backend-api#Plants (collection + tracker)\\|plants API]] |
| T-09 | Open-Meteo proxy + cache + `getWateringForecast()` logic + widget | 4 | 2026-09-01 (`pending-commit`) | [[docs/api-integrations]] |
| T-22 | API & auth test pass (A1–A10) | 4,6 | 2026-09-01 (`pending-test-run`) | [[docs/testing-strategy#2. API & Auth Tests (scripted — HTTP against running server)|api tests]] |
